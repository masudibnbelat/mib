...
export const skillsData: CategorySection[] = [
  {
    title: "Languages",
    skills: [
      { icon: "/Service/javascript.svg", name: "JavaScript", level: "Master" },
      { icon: "/Service/Typescript.svg", name: "TypeScript", level: "Master" },
      { icon: "/Service/python.svg", name: "Python", level: "Master" },
      { icon: "/Service/go.svg", name: "Golang", level: "Beginner" },
    ],
  },
  {
    title: "Frontend",
  ...
  },
  {
    ...
    skills: [
      ...
      { icon: "/Service/zed.webp", name: "Zed", level: "Intermediate" },
      ...
      { icon: "/Service/linux.svg", name: "Linux", level: "Master" },
      { icon: "/Service/archlinux.svg", name: "Arch Linux", level: "Master" },
    ],
  },
  {
    title: "Design",
