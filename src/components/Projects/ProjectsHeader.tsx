...
const HeaderSkeleton = () => (
  <div className="mt-20 w-full">
    <div className="h-80 w-full animate-pulse rounded-2xl bg-neutral-200 dark:bg-neutral-800 md:h-105" />
  </div>
);
...
const ProjectsHeader = () => {
  ...
  return (
    <div className="mt-20 w-full">
      <div className="group relative h-80 w-full overflow-hidden rounded-2xl md:h-105">
        <Swiper
          modules={[Autoplay]}
          onSwiper={(swiper) => {
